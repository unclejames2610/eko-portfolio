    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
          I have a dedidcation to continuous learning and staying updated with the latest trends in information technology. I&apos;m an active team player in collaborative environments, knowledge-sharing, and have proven success in work efficiency. Let&apos;s work together to innovatively strengthen and ensure sustained productivity in your company IT infrastructure.
          </p>
          {/* <Link href='/#projects'>
